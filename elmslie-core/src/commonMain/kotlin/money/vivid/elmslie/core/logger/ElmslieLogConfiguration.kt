...
class ElmslieLogConfiguration {
  ...
  fun fatal(strategy: LogStrategy) = apply { strategies[LogSeverity.Fatal] = strategy }

  /** Report an error in client code which can be identified as bug with certainty */
  fun nonfatal(strategy: LogStrategy) = apply { strategies[LogSeverity.NonFatal] = strategy }

  /** Print informational message */
  fun debug(strategy: LogStrategy) = apply { strategies[LogSeverity.Debug] = strategy }
